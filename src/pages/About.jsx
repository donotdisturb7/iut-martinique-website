...
const About = () => {
  ...
  return (
    <PageLayout pageName="L'IUT">
      {/* Hero section */}
      <div className="bg-primary-600 text-white py-10 md:py-14 lg:py-16 mb-8 md:mb-12">
        <Container>
          <motion.div
          ...
          >
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-4 leading-tight">L'IUT de la Martinique</h1>
            <p className="text-lg md:text-xl">Excellence, Innovation et Insertion professionnelle</p>
          </motion.div>
        </Container>
      </div>
      ...
      <Container>
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Notre Mission</h2>
        ...
        >
          <div className="bg-gray-50 rounded-lg p-6 md:p-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Mot de la Direction</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="md:col-span-2">
                <p className="text-gray-700 mb-4 italic text-base md:text-lg">
